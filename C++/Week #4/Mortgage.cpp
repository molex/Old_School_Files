...
int main(void)
{
	...
	cout << "Mortgage Calculator Version 4.0"<< endl;
	while (keepGoing){
    ...
    //display results
    double startingBalance = totalLoan;
	...
	cout << paymentNumber << setiosflags(ios::fixed) << setprecision(2) << startingBalance << principal << monthlyInterest << 
	}
