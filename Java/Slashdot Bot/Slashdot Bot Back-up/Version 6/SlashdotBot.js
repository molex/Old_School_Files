 ...
 * 
 * @modified by molex333@gmail.com (Michael Brown)
 * Added the Slashdot Logo into the main entry window and changed the default color for the headlines to be #006666
 */
 ...
 * @type Number
 */
GFdynamicFeedControl.DEFAULT_DISPLAY_TIME = 8000;
/*
...
GFdynamicFeedControl.prototype.createSubContainers_ = function() {
  ...
  var logo = this.createDiv_('gf-entry');
  //logo.className = 'gfg-title';
  logo.innerHTML = '<img src="http://www.m1cr0sux0r.com/topicslashdot.gif" alt="Slashdot Logo" href="http://www.slashdot.org">';
  
  nodes.root.appendChild(nodes.title);
  nodes.root.appendChild(nodes.entry);
  nodes.root.appendChild(logo);
